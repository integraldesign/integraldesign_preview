...
?>
    <section id="portfolio">
        <div class="container">
            <div class="center">
               <h2><?php echo $lang['MENU_FERROVIARIO']; ?></h2>
